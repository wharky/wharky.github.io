    ...
    private static String generatePrompt(String categoryKey) {
        ...
        switch (categoryKey) {
            ...
            case "lore":
                ...
                sb.append("아래 [재료 키워드] 중 2개를 무작위로 골라 믹스 앤 매치(Mix & Match)하여, **지금껏 어디서도 본 적 없는 새로운 세계관** 을 즉석에서 창조하세요. 너무 터무니 없는 조합이라면 **하나만 새로 뽑아 사용해도 좋습니다**.\n");
                sb.append("클리셰를 비틀거나 누구나 쉽게 생각하지 못 했을 법한 참신함이 필요합니다.\n\n");
                sb.append("[재료 키워드]: ").append(topics).append("\n\n");
                sb.append("--- [Lore 작성 미션 (목차 준수 및 어떠한 재료 키워드가 사용 되었는지 반드시 기재)] ---\n");
